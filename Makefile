...
# translation
SOURCES = livestats.py ui_livestats.py __init__.py livestatsdialog.py
#TRANSLATIONS = i18n/livestats_en.ts
TRANSLATIONS = 

# global

PLUGINNAME = livestats

PY_FILES = livestats.py livestatsdialog.py __init__.py

EXTRAS = icon.png 

UI_FILES = ui_livestats.py
